...
'However, if you use the contact form in the app to send feedback,  will ask you to provide us with your: email address, first name and last name. This information may be retained and used by us to respond to your feedback.'
'\n\nHOW DO I USE YOUR PERSONAL INFORMATION? \n\nI use the User Engagement Information listed above (iOS and Android versions) that I collect to help us improve and optimise our app (for example, by eliminating code errors). '
'Furthermore, I may use App Store and Google Play information to assess the success of our marketing and advertising campaigns. '
...
'\n\nCONTACT US\n\nFor more information about my privacy practices, if you have questions, or if you would like to make a complaint, please contact me via my website contact form (https://www.jurgengeitner.com/contact/) '
